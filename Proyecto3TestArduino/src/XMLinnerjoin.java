public class XMLinnerjoin {
    public static void main(String[] args) {
        ...
        String filePath2 = rutaProyecto2 + "/src/" + nombreArchivo2 + "/" + nombreArchivo2 + ".xml";
        //XMLreader.readXML(filePath2);
        String[][] Matriz1=XMLreader.readXML(filePath);
        String[][] Matriz2=XMLreader.readXML(filePath2);
        System.out.println("\n"+"Matriz Innerjoin"+"\n");
        ...
        String filePath3 = rutaProyecto3 + "/src/" + nombreArchivo3 + "/" + nombreArchivo3 + ".xml";
